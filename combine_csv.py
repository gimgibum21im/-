...
# 2021 데이터 파일 경로
data_21_files = [
    '2021/소상공인시장진흥공단_상가(상권)정보_경기_202106.csv',
    '2021/소상공인시장진흥공단_상가(상권)정보_부산_202106.csv',
    '2021/소상공인시장진흥공단_상가(상권)정보_서울_202106.csv',
    '2021/소상공인시장진흥공단_상가(상권)정보_제주_202106.csv'
]
...
def save_by_region(data, year):
    ...
    for region in regions:
        ...
        filename = f"{year}_{region}.csv"
        region_data.to_csv(filename, index=False, encoding='utf-8-sig')

# 2017, 2019, 2021 데이터 지역별 저장
save_by_region(data_17, "2017")
save_by_region(data_19, "2019")
save_by_region(data_21, "2021")