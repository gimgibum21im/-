...
# 2019 데이터 파일 경로와 필터
data_19_files = [
    '상가업소_201906/소상공인시장진흥공단_상가업소정보_201906_01.csv',
    '상가업소_201906/소상공인시장진흥공단_상가업소정보_201906_03.csv',
    '상가업소_201906/소상공인시장진흥공단_상가업소정보_201906_04.csv'
]
data_19_filters = [None, '시도명 == "경기도"', '시도명 == "제주특별자치도"']

# 2017 데이터 파일 경로와 필터
data_17_files = [
    '상가업소_201706/상가업소_201706_01.csv',
    '상가업소_201706/상가업소_201706_03.csv',
    '상가업소_201706/상가업소_201706_04.csv'
]
data_17_filters = [None, '시도명 == "경기도"', '시도명 == "제주특별자치도"']

# 2021 데이터 파일 경로
data_21_files = [
    '상가업소_202106/소상공인시장진흥공단_상가(상권)정보_경기_202106.csv',
    '상가업소_202106/소상공인시장진흥공단_상가(상권)정보_부산_202106.csv',
    '상가업소_202106/소상공인시장진흥공단_상가(상권)정보_서울_202106.csv',
    '상가업소_202106/소상공인시장진흥공단_상가(상권)정보_제주_202106.csv'
]

# 2023 데이터 파일 경로
data_23_files = [
    '상가업소_202306/소상공인시장진흥공단_상가(상권)정보_경기_202306.csv',
    '상가업소_202306/소상공인시장진흥공단_상가(상권)정보_부산_202306.csv',
    '상가업소_202306/소상공인시장진흥공단_상가(상권)정보_서울_202306.csv',
    '상가업소_202306/소상공인시장진흥공단_상가(상권)정보_제주_202306.csv'
]
