...
data_21_1 = pd.read_csv("소상공인시장진흥공단_상가(상권)정보_경기_202106.csv")
data_21_2 = pd.read_csv("소상공인시장진흥공단_상가(상권)정보_부산_202106.csv")
data_21_3 = pd.read_csv("소상공인시장진흥공단_상가(상권)정보_서울_202106.csv")
data_21_4 = pd.read_csv("소상공인시장진흥공단_상가(상권)정보_제주_202106.csv")
