...
# 파일 불러오기
data_19_1 = pd.read_csv('C:/Users/김유정/대학/2024-2/전통/기말프로젝트/소상공인시장진흥공단_상가업소정보_201906/소상공인시장진흥공단_상가업소정보_201906_01.csv')
data_19_2 = pd.read_csv('C:/Users/김유정/대학/2024-2/전통/기말프로젝트/소상공인시장진흥공단_상가업소정보_201906/소상공인시장진흥공단_상가업소정보_201906_03.csv')
data_19_3 = pd.read_csv('C:/Users/김유정/대학/2024-2/전통/기말프로젝트/소상공인시장진흥공단_상가업소정보_201906/소상공인시장진흥공단_상가업소정보_201906_04.csv')
data_17_1 = pd.read_csv('C:/Users/김유정/대학/2024-2/전통/기말프로젝트/상가업소_201706/상가업소_201706_01.csv', encoding='CP949')
data_17_2 = pd.read_csv('C:/Users/김유정/대학/2024-2/전통/기말프로젝트/상가업소_201706/상가업소_201706_03.csv', encoding='CP949')
data_17_3 = pd.read_csv('C:/Users/김유정/대학/2024-2/전통/기말프로젝트/상가업소_201706/상가업소_201706_04.csv', encoding='CP949')

filtered_2019_2 = data_19_2[data_19_2['시도명'] == '경기도']
filtered_2019_3 = data_19_3[data_19_3['시도명'] == '제주특별자치도']
filtered_2017_2 = data_17_2[data_17_2['시도명'] == '경기도']
filtered_2017_3 = data_17_3[data_17_3['시도명'] == '제주특별자치도']

combined_2019 = pd.concat([data_19_1, filtered_2019_2, filtered_2019_3], ignore_index=True)
combined_2017 = pd.concat([data_17_1, filtered_2017_2, filtered_2017_3], ignore_index=True)
